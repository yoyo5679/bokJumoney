...
const SUB_REGIONS = {
    ...
    'gyeonggi': ['수원시', '고양시', '용인시', '성남시', '부천시', '화성시', '안산시', '남양주시', '안양시', '평택시', '시흥시', '파주시', '의정부시', '김포시', '광주시', '광명시', '군포시', '하남시', '오산시', '양주시', '이천시', '구리시', '안성시', '의왕시', '여주시', '양평군', '동두천시', '과천시', '가평군', '연천군', '포천시'],
...
// ── 전국 시군구 법정동 코드(zipCd) 매핑 ──
const DISTRICT_ZIP_CODES = {
    'seoul': {
        '강남구': '11680', '강동구': '11740', '강북구': '11305', '강서구': '11500', '관악구': '11620', '광진구': '11215', '구로구': '11530', '금천구': '11545', '노원구': '11350', '도봉구': '11320', '동대문구': '11230', '동작구': '11590', '마포구': '11440', '서대문구': '11410', '서초구': '11650', '성동구': '11200', '성북구': '11290', '송파구': '11710', '양천구': '11470', '영등포구': '11560', '용산구': '11170', '은평구': '11380', '종로구': '11110', '중구': '11140', '중랑구': '11260'
    },
    'gyeonggi': {
        '수원시': '41110', '고양시': '41280', '용인시': '41460', '성남시': '41130', '부천시': '41190', '화성시': '41590', '안산시': '41270', '남양주시': '41360', '안양시': '41170', '평택시': '41220', '시흥시': '41390', '파주시': '41480', '의정부시': '41150', '김포시': '41570', '광주시': '41610', '광명시': '41210', '군포시': '41410', '하남시': '41450', '오산시': '41370', '양주시': '41630', '이천시': '41500', '구리시': '41310', '안성시': '41550', '의왕시': '41430', '여주시': '41670', '양평군': '41830', '동두천시': '41250', '과천시': '41290', '가평군': '41820', '연천군': '41800', '포천시': '41650'
    },
    'busan': {
        '강서구': '26440', '금정구': '26410', '기장군': '26710', '남구': '26290', '동구': '26170', '동래구': '26260', '부산진구': '26230', '북구': '26320', '사상구': '26530', '사하구': '26380', '서구': '26140', '수영구': '26500', '연제구': '26470', '영도구': '26200', '중구': '26110', '해운대구': '26350'
    },
    'incheon': {
        '강화군': '28710', '계양구': '28245', '남동구': '28200', '동구': '28140', '미추홀구': '28177', '부평구': '28237', '서구': '28260', '연수구': '28185', '옹진군': '28720', '중구': '28110'
    },
    'daegu': {
    ...
    'gangwon': {
        '춘천시': '51110', '원주시': '51130', '강릉시': '51150', '동해시': '51170', '태백시': '51190', '속초시': '51210', '삼척시': '51230', '홍천군': '51720', '횡성군': '51730', '영월군': '51750', '평창군': '51760', '정선군': '51770', '철원군': '51780', '화천군': '51790', '양구군': '51800', '인제군': '51810', '고성군': '51820', '양양군': '51830'
    },
    'chungbuk': {
        '청주시': '43110', '충주시': '43130', '제천시': '43150', '보은군': '43720', '옥천군': '43730', '영동군': '43740', '증평군': '43745', '진천군': '43750', '괴산군': '43760', '음성군': '43770', '단양군': '43800'
    },
    'chungnam': {
        '천안시': '44130', '공주시': '44150', '보령시': '44180', '아산시': '44200', '서산시': '44210', '논산시': '44230', '계룡시': '44250', '당진시': '44270', '금산군': '44710', '부여군': '44760', '서천군': '44770', '청양군': '44790', '홍성군': '44800', '예산군': '44810', '태안군': '44825'
    },
    'jeonbuk': {
        '전주시': '45110', '군산시': '45130', '익산시': '45140', '정읍시': '45180', '남원시': '45190', '김제시': '45210', '완주군': '45710', '진안군': '45720', '무주군': '45730', '장수군': '45740', '임실군': '45750', '순창군': '45770', '고창군': '45790', '부안군': '45800'
    },
    'jeonnam': {
        '목포시': '46110', '여수시': '46130', '순천시': '46150', '나주시': '46170', '광양시': '46230', '담양군': '46710', '곡성군': '46720', '구례군': '46730', '고흥군': '46770', '보성군': '46780', '화순군': '46790', '장흥군': '46800', '강진군': '46810', '해남군': '46820', '영암군': '46830', '무안군': '46840', '함평군': '46860', '영광군': '46870', '장성군': '46880', '완도군': '46890', '진도군': '46900', '신안군': '46910'
    },
    'gyeongbuk': {
        '포항시': '47110', '경주시': '47130', '김천시': '47150', '안동시': '47170', '구미시': '47190', '영주시': '47210', '영천시': '47230', '상주시': '47250', '문경시': '47280', '경산시': '47290', '의성군': '47730', '청송군': '47750', '영양군': '47760', '영덕군': '47770', '청도군': '47820', '고령군': '47830', '성주군': '47840', '칠곡군': '47850', '예천군': '47900', '봉화군': '47920', '울진군': '47930', '울릉군': '47940'
    },
    'gyeongnam': {
        '창원시': '48120', '진주시': '48170', '통영시': '48220', '사천시': '48240', '김해시': '48250', '밀양시': '48270', '거제시': '48310', '양산시': '48330', '의령군': '48720', '함안군': '48730', '창녕군': '48740', '고성군': '48820', '남해군': '48840', '하동군': '48850', '산청군': '48860', '함양군': '48870', '거창군': '48880', '합천군': '48890'
    },
    'jeju': {
...
function matchYouthPolicy(policy, userAnswers) {
    ...
    if (userAnswers.region) {
        ...
        const districtZip = (DISTRICT_ZIP_CODES[userAnswers.region] || {})[userAnswers.subRegion] || null;
...
async function fetchLocalYouthPolicies(userAnswers) {
...
function showResult() {
    ...
    // 메시지 업데이트 (혜택 개수 기준으로 통일 - score 잔재 제거)
    let title = '복주머니가 혜택으로 가득 찼어요! 🧧';
    if (benefits.length < 5) title = '복주머니에 담을 혜택을 더 찾아볼까요?';
    else if (benefits.length < 15) title = '실속 있는 복지 혜택이 가득 담겼네요!';
    else if (benefits.length < 30) title = '와! 복주머니가 묵직할 정도로 혜택이 많아요!';
    ...
    if (selectedRegion && REGION_ZIP_CODES[selectedRegion]) {
        ...
        fetchLocalYouthPolicies(answers).then(apiPolicies => {
